...
/// <summary>
/// Small, versioned, length-prefixed protocol for the one-shot elevated helper. A fresh
/// 256-bit secret and challenge authenticate each connection before request data is sent.
/// </summary>
public static class SourceAdminPipeProtocol
{
    ...
    public const string PipeNamePrefix = "PackagePilot.SourceAdmin.";

    private static readonly byte[] ProofDomain =
        Encoding.UTF8.GetBytes("PackagePilot.SourceAdmin.v1\0");

    private static readonly JsonSerializerOptions SerializerOptions = CreateJsonOptions();

    /// <summary>Returns a copy for diagnostics/tests without exposing mutable wire settings.</summary>
        ...
        try
        {
            ...
            if (actualProof.Length != ProofBytes)
            {
                ...
                throw new UnauthorizedAccessException(
                    "The elevated source helper returned an invalid authentication proof.");
            }
            ...
            try
            {
                ...
                {
                    throw new UnauthorizedAccessException(
                        "The elevated source helper did not authenticate the pipe connection.");
                }
            }
            finally
            {
        ...
        try
        {
            ...
            if (challenge.Length != ChallengeBytes)
            {
                ...
                throw new InvalidDataException(
                    "The elevated source broker returned an invalid authentication challenge.");
            }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new InvalidDataException("The source helper message is too large.");
        }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            return JsonSerializer.Deserialize<T>(payload, SerializerOptions)
                ?? throw new InvalidDataException("The source helper message was empty.");
        }
        finally
        {
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new InvalidDataException("The source helper frame length is invalid.");
        }
        ...
        out byte[] secret)
    {
        ...
        {
            throw new ArgumentException("The source helper pipe credentials are invalid.");
        }
    }
